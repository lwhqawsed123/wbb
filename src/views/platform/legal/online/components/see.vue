<template>
  <div class="abcd">
      ...
      <el-col :span="24">
        ...
        >
          <el-form-item label="业主姓名:">
            <el-input @keyup.enter.native="query" @clear="query" v-model.trim="formInline.name" placeholder="请输入" clearable></el-input>
          </el-form-item>
          <el-form-item label="状态:">
            <el-select @change="query" clearable v-model="formInline.pId" placeholder="请选择" size="mini">
              <el-option
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="projectName" show-overflow-tooltip label="委托编号" width="200px"></el-table-column>
      <el-table-column prop="name" show-overflow-tooltip label="欠费业主姓名" width="200px"></el-table-column>
      <el-table-column prop="idCard" show-overflow-tooltip label="联系方式" width="200px"></el-table-column>
      <el-table-column prop="phone" show-overflow-tooltip label="欠费业主详细地址" width="200px"></el-table-column>
      <el-table-column prop="jobName" show-overflow-tooltip label="欠费金额(不含滞纳金)" width="200px"></el-table-column>
      <el-table-column show-overflow-tooltip label="欠费时间段" width="200px">
        <template slot-scope="scope">{{scope.row.startTime.split(' ')[0]}}</template>
      </el-table-column>
      <!-- <el-table-column prop="endTime" show-overflow-tooltip label="投保结束日期" width="200px">
        <template slot-scope="scope">{{scope.row.endTime.split(' ')[0]}}</template>
      </el-table-column>-->
      <el-table-column prop="createTime" show-overflow-tooltip label="状态" min-width="200px"></el-table-column>
      <el-table-column prop="createTime" show-overflow-tooltip label="操作" min-width="200px">
        <template slot-scope="scope">
          <a href="javascript:;" style="color: #1890ff;" v-if="scope.row.status == '已生成'">下载PDF</a>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页 -->
