...
<script>
// insEmpCustomApplyManageApplyFile
import { insEmpCustomApplyManageApplyFile } from "@/api/information/information";
export default {
  name: "",
  props: ["obj"],
  data() {
  ...
  methods: {
    getData(){
      insEmpCustomApplyManageApplyFile(this.obj.id).then(xhrData=>{
        // console.log(xhrData);
        if(xhrData.code === 200){
          let  arr1 = []
          let arr2 = []
