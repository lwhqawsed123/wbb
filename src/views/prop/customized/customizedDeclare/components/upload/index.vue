...
export default {
  ...
  methods: {
    ...
    submission() {
      ...
      this.obj.form.insEmpApplyUsers.forEach((item, index) => {
      ...
      const jsonData = {
        ...
        // 周期
        cycle: this.obj.form.cycle,
        // 开始时间
        startTime: this.obj.form.startTime,
        // 保险公司id
        insCompId: this.obj.form.company,
        // 方案id
        planId: this.obj.form.code,
        // 订单号
        orderNo: this.obj.orderId,
        // policyNo: this.obj.orderId
        // 生成的图片
        policyFile:this.obj.policyFile
      };
      if (
