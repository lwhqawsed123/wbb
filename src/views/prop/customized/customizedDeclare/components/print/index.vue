<template>
  ...
  <div class="printing-wrap">
    ...
    <printf-template1 :policyInfo="obj" :orderId='orderId' style="display: none"></printf-template1>
    <printf-template2
      :policyInfo="obj.propertyData"
      :policyList="obj.form.insEmpApplyUsers"
      style="display: none"
    ></printf-template2>
...
export default {
  ...
  methods: {
    ...
    async next() {
      ...
      this.obj.orderId = this.orderId
      
      this.$emit("changePage", "UPLOAD", this.obj);
    },
    // 上一步
    goBack() {
