    ...
    <div id="printf-box2">
        ...
        <div class="wrap-box2">
          <table width="1000" cellspacing="0" align="center">
            <caption align="center">公众责任险清单</caption>
            <tr align="center">
              <td>序号</td>
              <td>项目名称</td>
              <td >项目地址</td>
            ...
            <tr align="center" v-for="(item,index) in policyList" :key="index">
              ...
              <td class="printing2-td2">{{item.name.name}}</td>
              <td class="printing2-td3">{{item.diziData}}</td>
              <td class="printing2-td4">{{item.type}}</td>
              <td class="printing2-td5">{{item.share}}</td>
              <td class="printing2-td6">{{item.startTime}}</td>
              <td class="printing2-td6">{{item.endTime}}</td>
              <td class="printing2-td7">{{item.mj}}</td>
              <td class="printing2-td8">{{item.yc}}</td>
            </tr>
          </table>
        </div>
