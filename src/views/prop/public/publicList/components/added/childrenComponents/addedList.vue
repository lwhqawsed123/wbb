      ...
      <el-col :span="24">
        ...
        >
          ...
          <el-form-item>
            ...
            <el-button v-if="idData.state =='在保'" type="primary" plain @click="addedDeclare" v-hasPermi="['ins:pub:new:add']">新增</el-button>
...
// 请求
import {
  insPubGetNewApplyList,
  insPubGetNewApplyDetail
...
export default {
  ...
  methods: {
    ...
    getBeanList() {
      ...
      insPubGetNewApplyList(page).then(xhrData => {
        // console.log(xhrData);
        // 申报状态 0申报中 1批改成功
        if (xhrData.code === 200) {
    ...
    see(row) {
      ...
      // 根据当前id查看详情
      insPubGetNewApplyDetail(row.id).then(xhrData => {
