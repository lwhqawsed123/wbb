      ...
      <el-col :span="24">
        ...
        >
          ...
          <el-form-item>
            ...
            <el-button v-if="obj.state =='在保'" type="primary" plain @click="surrender" v-hasPermi="['ins:pub:return:add']">申请退保</el-button>
...
// 请求
import {
  insPubGetReturnApplyList,
  insPubGetReturnApplyDetail
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      // console.log(page);
      insPubGetReturnApplyList(page).then(xhrData => {
