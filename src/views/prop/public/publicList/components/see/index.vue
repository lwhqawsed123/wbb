      ...
      <el-col :span="24">
        ...
        >
          ...
          <el-form-item>
            ...
            <el-button type="warning" plain @click="handleExport" v-hasPermi="['ins:pub:record:detail:export']">导出</el-button>
...
// 请求
import {
  insPubGetInsPubApplyDetailList,
  insPubExportInsPubDetailApply
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      insPubGetInsPubApplyDetailList(page).then(xhrData => {
        // console.log(xhrData);
        if (xhrData.code === 200) {
    ...
    handleExport() {
      ...
      this.$confirm("是否确认导出数据项?", "警告", {
        ...
        .then(function() {
          return insPubExportInsPubDetailApply(formInline);
        })
        .then(response => {
