...
<template>
  <div class="printf-template" style="display: none">
                      ...
                      <div class="page-table">
                          <table border="0" cellspacing="0" cellpadding="0">
                             ...
                             <tr>
                              ...
                              <tr>
                                  <td class="title lt" colspan="4" >兹经投保人申请，公司同意自 {{printData.startTime}}，对保单做如下批改</td>
                              </tr>
  
                          </table>
                          <div class="page-title title tn">
                            被保险人投保雇员由 {{printData.beforeNum}} 人变更为{{printData.afterNum}} 人  后附投保雇员变更名单
                          </div>
    ...
    #printf-box2 .printf-box-content .page-title.title.tn{
        padding: 5px 0;
        text-indent: 0em;
    }
    </div>
