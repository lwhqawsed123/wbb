<template>
  <!-- 查看并打印 -->
    <div class="printing-wrap">
      ...
      <printf-template2 :policyInfo="propertyData" :policyList="arrData" style="display: none"></printf-template2>
      <!-- <img :src="srcImg" alt=""> -->
      <!-- <img class="paymentDialog-box-img2" :src="'data:image/png;base64,'+srcImg" alt /> -->
...
export default {
  ...
  created() {
    // console.log(this.propertyData, "shuju");
    this.getMoney();
    this.getPremium();
  ...
  methods: {
    ...
    getPremium() {
      ...
      // console.log(arr);
      const jsonData = {
        insPropDetailList: arr
      };
      // console.log(jsonData);
      
      insPropGetTotalPremium(jsonData).then(xhrData => {
    ...
    async next() {
      ...
      if(base64Img == ''){
        ...
        $.ajax({
          ...
          error: function(data) {
            // console.log(data, "失败11");
          }
        });
      }
      // console.log(this.arrData,this.propertyData);
      
      this.$emit("changePage", "UPLOAD",this.arrData,this.propertyData);
    },
    // 上一步
    goBack() {
    ...
    htmlToPrint1() {
      // this.html2canvas()
      // let htmlabc = "<script>" + document.getElementById("abc").innerHTML+"</" +
      //   "script>";
      ...
      // let SCRIPT_PRINT90 =
      //   "<script>" +
      //   document.getElementById("SCRIPT_PRINT99").innerHTML +
      //   "</" +
      //   "script>";
      let SCRIPT_PRINT =
        "<script>" +
        ...
        "script>";
        // let SCRIPT_PRINT2 =
        // "<script src='../../../../../../assets/styles/canvas.js'>" +"</" +"script>";
