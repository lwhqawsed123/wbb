...
// 保险条款
import { propertyClause,propertyRisk } from "@/validate/programme"
export default {
  ...
  created() {
    ...
    this.insuranceClause = propertyClause()
    // this.getProjecData();
    // this.getMoney();
    this.getApplyData();
  ...
  methods: {
    ...
    validityTerm(val, index) {
      ...
      if (this.fromData.tableData[index].type == "居住类型") {
        // 判断是否有游泳池
        if (this.isSwimming) {
          this.fromData.tableData[index].bf = (Number(this.keepDay * this.liveDayPremium * this.fromData.tableData[index].share) + 500).toFixed(2);
        } else {
          this.fromData.tableData[index].bf = (Number(this.keepDay * this.liveDayPremium * this.fromData.tableData[index].share)).toFixed(2);
        }
      } else if (this.fromData.tableData[index].type == "非居住类型") {
         // 判断是否有游泳池
        if (this.isSwimming) {
          this.fromData.tableData[index].bf = (Number(this.keepDay * this.NonLiveDayPremium * this.fromData.tableData[index].share) + 500).toFixed(2);
        } else {
          this.fromData.tableData[index].bf = (Number(this.keepDay * this.NonLiveDayPremium * this.fromData.tableData[index].share)).toFixed(2);
        }
    ...
    calculate(val, index) {
      ...
      if (this.fromData.tableData[index].type == "居住类型") {
        if(this.isSwimming){
          this.fromData.tableData[index].bf = Number((num * this.liveDayPremium * this.keepDay)+500).toFixed(2);
        }else{
          this.fromData.tableData[index].bf = Number((num * this.liveDayPremium * this.keepDay)).toFixed(2);
        }
      } else if (this.fromData.tableData[index].type == "非居住类型") {
         if(this.isSwimming){
          this.fromData.tableData[index].bf = Number((num * this.NonLiveDayPremium * this.keepDay)+500).toFixed(2);
        }else{
          this.fromData.tableData[index].bf = Number((num * this.NonLiveDayPremium * this.keepDay)).toFixed(2);
        }
      }
    },
    // 是否有泳池
