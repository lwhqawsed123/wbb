  ...
  <div class="declare" id="declare">
    <div class="declare-conter">
      ...
      >
        ...
        <div v-show="isAdditional" class="type-box">
          <el-checkbox disabled v-model="type1">伤残赔付特约 / 年</el-checkbox>
        </div>
        <div v-show="isAdditional" class="type-box">
          <el-checkbox disabled v-model="type2">扩展24小时 / 年</el-checkbox>
        </div>
...
export default {
  ...
  methods: {
    ...
    async getEmpData() {
      ...
      this.correctionStartTime = yearSecond+'-'+monthSecond+'-'+daySecond
      // 计算天数差
