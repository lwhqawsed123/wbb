<template>
  <div>
      ...
      <el-col :span="24">
        ...
        >
          ...
          <el-form-item label="项目名称:">
            <el-input @keyup.enter.native="query" v-model.trim="formInline.projectName" placeholder="请输入"></el-input>
            <!-- <el-select @change="query" clearable v-model="formInline.state" placeholder="请选择">
              <el-option label="申报中" value="0"></el-option>
              <el-option label="批改成功" value="1"></el-option>
            </el-select> -->
          ...
          <el-form-item>
            ...
            <el-button type="primary" plain @click="replaceBtn">退保</el-button>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="name" show-overflow-tooltip label="雇员姓名" width="200px"></el-table-column>
      <el-table-column prop="idCard" show-overflow-tooltip label="雇员身份证" width="200px"></el-table-column>
      <el-table-column prop="phone" show-overflow-tooltip label="雇员手机号" width="200px"></el-table-column>
      <el-table-column prop="state" show-overflow-tooltip label="审核状态" width="200px">
    ...
    ></el-pagination>
    <!--  对话框 -->
    <el-dialog :title="titleName" class="seeDialog" :visible.sync="dialogVisible" width="600px"  @close='closeDialog'>
    ...
    surrender() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          ...
          insEmpApplyManageReturn(this.form.name.id).then(xhrData => {
            if (xhrData.code === 200) {
              this.$message({
                message: "退保成功！",
                type: "success"
