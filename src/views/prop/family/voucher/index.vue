  ...
  <div class="record">
    <div class="record-conter">
        ...
        <el-col :span="21">
          <el-form :inline="true" :model="formInline" class="demo-form-inline">
            ...
            <el-form-item label="手机号：">
              <el-input maxlength="11" @keyup.enter.native="onSubmit" v-model.trim="formInline.mobileNo" placeholder="请输入"></el-input>
            </el-form-item>
            <!-- <el-form-item>
              <el-select @change="onSubmit" clearable v-model="formInline.productId" placeholder="保额">
                <el-option
      ...
      >
        ...
        <el-table-column prop="insureAmount" label="保额(万)" min-width="100px" show-overflow-tooltip>
         
        </el-table-column>
        <el-table-column prop="mobileNo" label="手机号" min-width="140px" show-overflow-tooltip>
        ...
        <el-table-column
          ...
          min-width="200px"
        ></el-table-column>
        <el-table-column label="保单状态" min-width="140px">
          <template slot-scope="scope">
            <a href="javascript:;" style="color: #1890ff;" v-if="scope.row.status == '已生成'" @click="voucher(scope.row)">电子凭证</a>
            <span v-else-if="scope.row.status != '已生成'">-</span>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
